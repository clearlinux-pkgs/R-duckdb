...
Version  : 1.0.0.2
Release  : 1
URL      : https://cran.r-project.org/src/contrib/duckdb_1.0.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/duckdb_1.0.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721841868
