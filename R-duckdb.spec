...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/duckdb_1.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746030044
...
/usr/lib64/R/library/duckdb/tests/testthat/_snaps/array.md
...
/usr/lib64/R/library/duckdb/tests/testthat/_snaps/relational.md
...
/usr/lib64/R/library/duckdb/tests/testthat/test-array.R
...
/usr/lib64/R/library/duckdb/tests/testthat/test-date.R
...
/usr/lib64/R/library/duckdb/tests/testthat/test-progress_display.R
...
/usr/lib64/R/library/duckdb/tests/testthat/test-scan.R
/usr/lib64/R/library/duckdb/tests/testthat/test-shutdown.R
/usr/lib64/R/library/duckdb/tests/testthat/test-signal.R
